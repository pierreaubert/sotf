...
pub(super) fn target_mean_spl(channel_name: &str, channel_mean_spl: f64, shared_mean_spl: Option<f64>) -> f64 {
...
pub(super) fn is_subwoofer_measurement_channel(channel_name: &str, room_config: &RoomConfig) -> bool {
