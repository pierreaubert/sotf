...
# [allow (unused_imports)] pub (super) use super::schroeder :: { optimize_with_schroeder_split } ;
...
pub(in super::super) fn process_single_speaker(
    ...
    match room_config.optimizer.processing_mode {
                ...
                match load::load_source_individual(source) {
                    Ok(curves) if curves.len() > 1 => {
                        let sr_config = room_config
                            ...
                            .map(|sc| super::super::spatial_robustness::SpatialRobustnessConfig {
        ...
        ProcessingMode::KautzModal => {
            ...
            let decomposed_config = super::super::impulse_analysis::DecomposedCorrectionConfig::default();
