...
pub(super) fn build_target_tilt_curve(
    ...
    if effective_target.shape == TargetShape::FromMeasurement {
        let is_sub_or_lfe = super::super::home_cinema::role_for_channel(channel_name).is_sub_or_lfe();
    ...
    if effective_target.shape != TargetShape::Flat
        ...
        || super::super::home_cinema::role_target_curve_shape_active(channel_name, &effective_target)
    {
        info!(
