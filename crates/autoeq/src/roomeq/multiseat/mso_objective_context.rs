...
impl MsoObjectiveContext {
    ...
    pub(super) fn from_baseline_with_freqs(responses: &[Vec<f64>], freqs: Option<&Array1<f64>>) -> Self {
...
pub(super) fn output_preservation_penalty(responses: &[Vec<f64>], context: &MsoObjectiveContext) -> f64 {
    mean_output_loss_penalty(responses, context)
        + null_deficit_penalty_from_responses(responses, context)
}

pub(super) fn headroom_pressure_penalty(responses: &[Vec<f64>], context: &MsoObjectiveContext) -> f64 {
