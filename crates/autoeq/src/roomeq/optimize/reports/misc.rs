...
pub(in super::super) fn recompute_curve_flatness_score(curve: &Curve, min_freq: f64, max_freq: f64) -> f64 {
...
pub(in super::super) fn final_score_band_for_channel(config: &RoomConfig, channel_name: &str) -> (f64, f64) {
...
pub(in super::super) fn bass_consistency_rms_db(channels: &HashMap<String, ChannelDspChain>) -> Option<f64> {
...
pub(in super::super) fn headroom_peak_boost_db(channels: &HashMap<String, ChannelDspChain>) -> Option<f64> {
