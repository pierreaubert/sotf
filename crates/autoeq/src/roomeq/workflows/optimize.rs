...
use super::super :: types :: { ChannelDspChain , DriverDspChain , OptimizationMetadata , RoomConfig , SpeakerConfig , SystemConfig } ;
...
pub(in super::super) fn optimize_stereo_2_1_with_progress(
    ...
    let mut bass_management_optimization = super::super::home_cinema::BassManagementOptimizationReport {
...
pub(in super::super) fn optimize_home_cinema_with_progress(
    ...
    let main_roles: Vec<String> = sys
        .speakers
        .keys()
        .filter(|r| *r != &sub_role && !super::super::home_cinema::role_for_channel(r).is_sub_or_lfe())
        .cloned()
        .collect();
...
fn optimize_home_cinema_with_sub(
    ...
    for role in main_roles {
        let group_id =
            super::super::home_cinema::group_id_for_role(super::super::home_cinema::role_for_channel(role));
    ...
    // Build per-driver chains if multi-sub
    let sub_output_by_role: HashMap<String, super::super::home_cinema::BassManagementSubOutputReport> =
