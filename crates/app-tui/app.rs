...
impl TuiEditablePlugin for sotf_audio_player::PluginSettings {
    fn get_descriptors(&self) -> Vec<TuiParamDescriptor> {
        ...
        match self {
            sotf_audio_player::PluginSettings::Gain { .. } => vec![TuiParamDescriptor {
                name: "Gain".into(),
            ...
            sotf_audio_player::PluginSettings::EQ { filters: _, max_filters, .. } => {
            ...
            sotf_audio_player::PluginSettings::Compressor { .. } => vec![
                TuiParamDescriptor {
                    name: "Threshold".into(),
                    param_type: TuiParamType::Float {
            ...
            sotf_audio_player::PluginSettings::Upmixer { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::Limiter { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::Gate { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::Expander { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::MultibandCompressor { num_bands, .. } => {
                let mut descs = vec![
            ...
            sotf_audio_player::PluginSettings::MultibandExpander { num_bands, .. } => {
                let mut descs = vec![
            ...
            sotf_audio_player::PluginSettings::LoudnessCompensation { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::FletcherMunson { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::BinauralDecoder { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::Convolution { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::XTC { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::Denoiser { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::Pnd { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::ABCompare { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::BandSplit { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::BandMerge { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::Downmix { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::MonoToStereo { .. } => vec![
            ...
            sotf_audio_player::PluginSettings::Crossfeed { .. } => vec![
    ...
    fn get_value_as_string(&self, index: usize) -> String {
        match self {
            ...
            sotf_audio_player::PluginSettings::EQ { filters, max_filters, .. } => {
                if index == 0 {
            ...
            sotf_audio_player::PluginSettings::BandMerge { bands, .. } => match index {
                0 => format!("{}", bands),
                _ => String::new(),
            },
            ...
            sotf_audio_player::PluginSettings::Crossfeed {
                mode,
                preset,
                enabled,
                mix,
                    ...
                    if *max_filters > old_max {
                        ...
                        while filters.len() < *max_filters {
                            filters.push(sotf_audio_player::EQFilter::new(
                                sotf_audio_player::BiquadFilterType::Peak,
                                1000.0,
                                1.0,
                                0.0,
                            ));
