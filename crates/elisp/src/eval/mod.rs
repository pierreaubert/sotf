                ...
                LispObject::Symbol(id) => {
                    ...
                    match sym_name.as_str() {
                        ...
                        "garbage-collect" => {
                            ...
                            drop(heap);
                            // Return ((conses . ALLOCATED) (gc-count . COUNT) (cons-total . TOTAL))
                            Ok(LispObject::cons(
                                LispObject::cons(
                        ...
                        "push" => {
                            ...
                            let val = eval(val_expr, env, editor, macros, state)?;
                            let place_name = place.as_symbol().ok_or_else(|| {
                        ...
                        "symbol-value" => {
                            ...
                            let name = arg.as_symbol().ok_or_else(|| {
                                ElispError::WrongTypeArgument("symbol".to_string())
                            })?;
                        ...
                        "set-default" => {
                            ...
                            let name = sym.as_symbol().ok_or_else(|| {
                                ElispError::WrongTypeArgument("symbol".to_string())
                            })?;
                        ...
                        "nconc" => {
                            ...
                            let result_idx = match result_idx {
                                Some(i) => i,
                                None => {
                                    return Ok(lists.last().cloned().unwrap_or(LispObject::nil()))
                                }
                            };
                        ...
                        "make-symbol" => {
                            ...
                            let s = name.as_string().ok_or_else(|| {
                                ElispError::WrongTypeArgument("string".to_string())
                            })?;
                        ...
                        "version-to-list" => {
                            ...
                            let ver_str = ver.as_string().ok_or_else(|| {
                                ElispError::WrongTypeArgument("string".to_string())
                            })?;
                            let mut result = LispObject::nil();
                        ...
                        "read-from-string" => {
                            ...
                            let text = s.as_string().ok_or_else(|| {
                                ElispError::WrongTypeArgument("string".to_string())
                            })?;
