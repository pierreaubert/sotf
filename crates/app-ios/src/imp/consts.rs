...
pub(super) static PENDING_IMPORTED_FILES: OnceLock<parking_lot::Mutex<Vec<PathBuf>>> =
    OnceLock::new();

pub(super) static PENDING_QR_PAYLOADS: OnceLock<parking_lot::Mutex<VecDeque<String>>> =
    OnceLock::new();
