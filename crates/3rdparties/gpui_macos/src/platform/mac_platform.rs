...
use ptr::null_mut;
use semver::Version;
use std :: { cell :: Cell , ffi :: { CStr , OsStr , c_void } , os :: { raw :: c_char , unix :: ffi :: OsStrExt } , path :: { Path , PathBuf } , ptr , rc :: Rc , str , sync :: { Arc , OnceLock } } ;
use util::{
    ResultExt,
    command::{new_command, new_std_command},
};
use super::consts::APP_CLASS;
use super::consts::APP_DELEGATE_CLASS;
use super::consts::MAC_PLATFORM_IVAR;
use super::consts::path_from_objc;
use super::misc::ns_url_to_path;
use super::misc::security;
use super::types::MacPlatformState;
...
impl MacPlatform {
    ...
    pub(super) unsafe fn create_menu_item(
        item: &MenuItem,
        delegate: id,
        actions: &mut Vec<Box<dyn Action>>,
        keymap: &Keymap,
