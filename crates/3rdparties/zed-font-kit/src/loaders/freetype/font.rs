...
use super::consts::OS2_FS_SELECTION_OBLIQUE;
use super::consts::PS_DICT_FULL_NAME;
use super::consts::TT_NAME_ID_FULL_NAME;
use super::consts::TT_PLATFORM_APPLE_UNICODE;
use super::f32_to_ft_fixed::F32ToFtFixed;
...
/// loader by default.
pub struct Font {
    pub(super) freetype_face: FT_Face,
    pub(super) font_data: Arc<Vec<u8>>,
}
...
impl Font {
    ...
    pub(super) fn get_type_1_or_sfnt_name(&self, type_1_id: u32, sfnt_id: u16) -> Option<String> {
        unsafe {
            let ps_value_size =
    ...
    pub(super) fn get_os2_table(&self) -> Option<*const TT_OS2> {
        unsafe {
    ...
    pub(super) fn hinting_and_rasterization_options_to_load_flags(
        &self,
        hinting: HintingOptions,
    ...
    pub(super) fn get_fallbacks(&self, text: &str, _locale: &str) -> FallbackResult<Font> {
        warn!("unsupported");
        FallbackResult {
            fonts: Vec::new(),
            valid_len: text.len(),
