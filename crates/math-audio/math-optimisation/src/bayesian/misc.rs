...
pub(super) fn matern52(a: &Array1<f64>, b: &Array1<f64>, lengthscales: &[f64], variance: f64) -> f64 {
    let mut r2 = 0.0;
    for i in 0..a.len() {
...
pub(super) fn kernel_matrix(x: &[Array1<f64>], lengthscales: &[f64], kernel_variance: f64) -> DMatrix<f64> {
    let n = x.len();
