...
mod format_tests {
    ...
    fn test_biquad_to_rme_type_unsupported_and_edge_positions() {
        ...
        assert_eq!(biquad_to_rme_type(BiquadFilterType::HighpassVariableQ, 1), 2.0);
        assert_eq!(biquad_to_rme_type(BiquadFilterType::HighpassVariableQ, 3), 3.0);
        assert_eq!(biquad_to_rme_type(BiquadFilterType::HighpassVariableQ, 9), 3.0);
        assert_eq!(biquad_to_rme_type(BiquadFilterType::HighpassVariableQ, 2), -1.0);
