...
use crate :: { DEFAULT_Q_HIGH_LOW_PASS } ;
...
use super::super::biquad_filter_type::BiquadFilterType;
    ...
    fn test_coefficients_finite_for_all_filter_types() {
        ...
        for &ft in &types {
            ...
            assert!(f64::is_finite(c.b0), "{}: b0 should be finite", ft.short_name());
            assert!(f64::is_finite(c.b1), "{}: b1 should be finite", ft.short_name());
            assert!(f64::is_finite(c.b2), "{}: b2 should be finite", ft.short_name());
            assert!(f64::is_finite(c.a1), "{}: a1 should be finite", ft.short_name());
            assert!(f64::is_finite(c.a2), "{}: a2 should be finite", ft.short_name());
