...
pub(super) fn build_sample_rate_candidates(requested_rate: u32, device_default: Option<u32>) -> Vec<u32> {
...
pub(super) fn match_device_priority(devices: &[(String, String)], identifier: &str) -> Option<usize> {
...
pub(super) fn summarize_available_device_names(device_info: &[(String, String)], limit: usize) -> String {
