    ...
    pub fn param_value(&self, index: usize) -> Option<f64> {
        match self {
            ...
            Self::XTC {
                ...
                5 => Some(*head_yaw_deg),
                6 => Some(*beta_base),
                7 => Some(*beta_low_freq_boost),
                8 => Some(*beta_high_freq_boost),
                9 => Some(*head_shadow_cutoff_hz),
                10 => Some(*head_shadow_slope_db_per_octave),
                11 => Some(*max_gain_db),
                12 => Some(b2f(*spectral_normalization)),
                13 => Some(b2f(*pinna_model_enabled)),
                14 => Some(b2f(*room_reflections_enabled)),
                15 => Some(*room_width_m),
                16 => Some(*room_depth_m),
                17 => Some(*wall_absorption),
                18 => Some(*reflection_beta_boost),
                19 => Some(b2f(*bypass_xtc_filters)),
                20 => Some(b2f(*bypass_spectral_normalization)),
                21 => Some(b2f(*bypass_neumann_refinement)),
                22 => Some(b2f(*auto_gain_enabled)),
                23 => Some(*auto_gain_max_db),
                24 => Some(*auto_gain_smoothing_ms),
                _ => None,
            },
            // ----------------------------------------------------------------
            Self::Denoiser {
    ...
    pub fn set_param_value(&mut self, index: usize, value: f64) {
        match self {
            ...
            Self::XTC {
                ...
                6 => *beta_base = value,
                7 => *beta_low_freq_boost = value,
                8 => *beta_high_freq_boost = value,
                9 => *head_shadow_cutoff_hz = value,
                10 => *head_shadow_slope_db_per_octave = value,
                11 => *max_gain_db = value,
                12 => *spectral_normalization = f2b(value),
                13 => *pinna_model_enabled = f2b(value),
                14 => *room_reflections_enabled = f2b(value),
                15 => *room_width_m = value,
                16 => *room_depth_m = value,
                17 => *wall_absorption = value,
                18 => *reflection_beta_boost = value,
                19 => *bypass_xtc_filters = f2b(value),
                20 => *bypass_spectral_normalization = f2b(value),
                21 => *bypass_neumann_refinement = f2b(value),
                22 => *auto_gain_enabled = f2b(value),
                23 => *auto_gain_max_db = value,
                24 => *auto_gain_smoothing_ms = value,
                _ => {}
            },
            // ----------------------------------------------------------------
            Self::Denoiser {
