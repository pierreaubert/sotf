    ...
    pub fn param_value(&self, index: usize) -> Option<f64> {
        match self {
            ...
            Self::FletcherMunson {
                ...
                0 => Some(*playback_volume_db),
                1 => Some(*reference_level_db),
                2 => Some(b2f(*enabled)),
                3 => Some(*smoothing_ms),
                4 => Some(b2f(*auto_gain_enabled)),
                5 => Some(*auto_gain_max_db),
                6 => Some(*auto_gain_smoothing_ms),
                7 => Some(*auto_gain_loudness_type as f64),
                8 => Some(*band1_freq),
                9 => Some(*band1_q),
                10 => Some(*band1_max_gain),
                11 => Some(*band1_slope),
                12 => Some(*band2_freq),
                13 => Some(*band2_q),
                14 => Some(*band2_max_gain),
                15 => Some(*band2_slope),
                16 => Some(*band3_freq),
                17 => Some(*band3_q),
                18 => Some(*band3_max_gain),
                19 => Some(*band3_slope),
                20 => Some(*band4_freq),
                21 => Some(*band4_q),
                22 => Some(*band4_max_gain),
                23 => Some(*band4_slope),
                _ => None,
            },
            // ----------------------------------------------------------------
            ...
            Self::Denoiser {
                ...
                16 => Some(b2f(*transient_enabled)),
                17 => Some(b2f(*spectral_smoothing_enabled)),
                18 => Some(b2f(*temporal_smoothing_enabled)),
                19 => Some(b2f(*hiss_enabled)),
                20 => Some(*hiss_threshold_db),
                21 => Some(*hiss_frequency_hz),
                22 => Some(*hiss_strength),
                23 => Some(b2f(*spectral_sub_enabled)),
                24 => Some(*spectral_sub_alpha),
                25 => Some(*spectral_sub_beta),
                26 => Some(b2f(*learn_noise)),
                27 => Some(b2f(*use_captured_profile)),
                28 => Some(b2f(*clear_profile)),
                _ => None,
            },
            // ----------------------------------------------------------------
            Self::Pnd {
    ...
    pub fn set_param_value(&mut self, index: usize, value: f64) {
        match self {
            ...
            Self::FletcherMunson {
                ...
                0 => *playback_volume_db = value,
                1 => *reference_level_db = value,
                2 => *enabled = f2b(value),
                3 => *smoothing_ms = value,
                4 => *auto_gain_enabled = f2b(value),
                5 => *auto_gain_max_db = value,
                6 => *auto_gain_smoothing_ms = value,
                7 => *auto_gain_loudness_type = value as i32,
                8 => *band1_freq = value,
                9 => *band1_q = value,
                10 => *band1_max_gain = value,
                11 => *band1_slope = value,
                12 => *band2_freq = value,
                13 => *band2_q = value,
                14 => *band2_max_gain = value,
                15 => *band2_slope = value,
                16 => *band3_freq = value,
                17 => *band3_q = value,
                18 => *band3_max_gain = value,
                19 => *band3_slope = value,
                20 => *band4_freq = value,
                21 => *band4_q = value,
                22 => *band4_max_gain = value,
                23 => *band4_slope = value,
                _ => {}
            },
            // ----------------------------------------------------------------
            Self::Upmixer {
            ...
            Self::Denoiser {
                ...
                16 => *transient_enabled = f2b(value),
                17 => *spectral_smoothing_enabled = f2b(value),
                18 => *temporal_smoothing_enabled = f2b(value),
                19 => *hiss_enabled = f2b(value),
                20 => *hiss_threshold_db = value,
                21 => *hiss_frequency_hz = value,
                22 => *hiss_strength = value,
                23 => *spectral_sub_enabled = f2b(value),
                24 => *spectral_sub_alpha = value,
                25 => *spectral_sub_beta = value,
                26 => *learn_noise = f2b(value),
                27 => *use_captured_profile = f2b(value),
                28 => *clear_profile = f2b(value),
                _ => {}
            },
            // ----------------------------------------------------------------
            Self::Pnd {
