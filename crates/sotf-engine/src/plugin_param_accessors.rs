    ...
    pub fn param_value(&self, index: usize) -> Option<f64> {
        match self {
            ...
            Self::Denoiser {
                ...
                19 => Some(b2f(*learn_noise)),
                20 => Some(b2f(*use_captured_profile)),
                21 => Some(b2f(*clear_profile)),
                _ => None,
            },
            // ----------------------------------------------------------------
            Self::Pnd {
    ...
    pub fn set_param_value(&mut self, index: usize, value: f64) {
        match self {
            ...
            Self::Denoiser {
                ...
                19 => *learn_noise = f2b(value),
                20 => *use_captured_profile = f2b(value),
                21 => *clear_profile = f2b(value),
                _ => {}
            },
            // ----------------------------------------------------------------
            Self::Pnd {
