pub use autoeq::roomeq::{
    CallbackAction, PipelineControl, PipelineEvent, PipelineObserver, RoomOptimizationCallback,
...
pub(super) fn room_callback_observer(
    mut callback: RoomOptimizationCallback,
