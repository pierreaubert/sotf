...
pub struct PlaylistController {
    ...
    pub(super) track_counts: Vec<usize>,
    ...
    pub(super) active_playlist: Option<Playlist>,
}
...
impl PlaylistController {
    ...
    pub(super) fn reload_active(&mut self, db: &MusicDatabase) -> Result<(), String> {
    ...
    pub(super) fn find_track_by_path<'a>(
