...
fn test_clear_library_content_removes_local_rows_but_keeps_sources() {
    ...
    let demo_file = super::fixtures::get_demo_file("classical.wav");
...
fn test_album_with_multiple_tracks() {
    ...
    let mut track1 = test_track(
        super::fixtures::get_demo_file("classical.wav"),
        "Track 1",
        "Multi Track Artist",
    );
    ...
    let mut track2 = test_track(
        super::fixtures::get_demo_file("jazz.wav"),
        "Track 2",
        "Multi Track Artist",
    );
    ...
    let mut track3 = test_track(
        super::fixtures::get_demo_file("rock.wav"),
        "Track 3",
        "Multi Track Artist",
    );
...
fn test_normalized_genre_table() {
    ...
    let track_path = super::fixtures::get_demo_file("classical.wav");
    let track_genre = db
...
fn test_genre_splitting_by_comma() {
    ...
    let track_path = super::fixtures::get_demo_file("rock.wav");
    let track_genres = db
