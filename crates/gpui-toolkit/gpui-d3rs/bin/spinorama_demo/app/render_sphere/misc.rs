...
impl SpinoramaApp {
    ...
    pub(super) fn interpolate_spl_at_freq(freq: &[f64], spl: &[f64], target_freq: f64) -> f64 {
    ...
    pub(super) fn interpolate_sphere_spl(
