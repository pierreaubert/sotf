...
use super::super :: render :: { freq_spl_plot_margins } ;
use super::super :: types :: { ChartId , Colormap , ContourRenderMode , DirectivityPlane , LoadState , PlotSection } ;
...
impl SpinoramaApp {
    pub(super) fn solve_shell_layout(&self, width: f32, height: f32, header_height: f32) -> SolvedNode {
    ...
    pub(super) fn is_fill_section(&self) -> bool {
    ...
    #[allow(dead_code)]
    pub(super) fn apply_zoom_from_selection(
        &mut self,
        chart_id: ChartId,
        sel: BrushSelection,
        chart_width: f32,
