...
pub(super) fn blend_pixel(pixels: &mut [u8], width: u32, height: u32, x: i32, y: i32, color: Rgba, alpha: u8) {
...
pub(super) fn blend_raw_pixel(pixels: &mut [u8], width: u32, height: u32, x: i32, y: i32, src: &[u8]) {
    if x < 0 || y < 0 || x >= width as i32 || y >= height as i32 {
        return;
    }
