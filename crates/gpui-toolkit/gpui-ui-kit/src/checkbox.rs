...
/// A checkbox component with builder pattern generated by FormField macro
#[derive(FormField)]
pub struct Checkbox {
    #[field(required)]
    id: ElementId,
    ...
    #[field(default = "CheckboxSize::default()")]
    size: CheckboxSize,
...
impl Checkbox {
    /// Set change handler (manually implemented since #[field(builder = false)])
