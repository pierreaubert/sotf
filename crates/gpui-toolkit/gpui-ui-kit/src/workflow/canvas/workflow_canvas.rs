...
impl WorkflowCanvas {
    ...
    pub(super) fn handle_double_click(&mut self, position: Position, window: &mut Window, cx: &mut App) {
        // position is in screen coordinates (relative to canvas element)
    ...
    pub(super) fn handle_add_node_menu(&mut self, node_type: &SharedString, cx: &mut Context<Self>) {
