...
use gpui::{SharedString, Window, App, Div, div, px, FontWeight, MouseButton};
...
pub struct MenuBar {
    ...
    pub(super) on_menu_toggle: Option<Box<dyn Fn(Option<&SharedString>, &mut Window, &mut App) + 'static>>,
}
