...
use gpui_design::{DesignExt, DesignSystem, DesignSystemState};
...
impl MiniAppShell {
    #[cfg(feature = "builder")]
    fn solve_content_layout(width: f32, height: f32, min_content_width: f32) -> SolvedNode {
    ...
    #[cfg(feature = "builder")]
    fn content_size(width: f32, height: f32, design: &DesignSystem) -> (f32, f32) {
    ...
    fn content_size(width: f32, height: f32, _design: &DesignSystem) -> (f32, f32) {
        (width, height)
    }
}
...
mod tests {
    ...
    fn test_miniapp_shell_solves_content_slot_with_builder() {
        let solved = super::MiniAppShell::solve_content_layout(800.0, 600.0, 8.0);
