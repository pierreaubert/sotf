...
use crate :: { ChartSize , DEFAULT_PADDING_FRACTION , DEFAULT_TITLE_FONT_SIZE , ScaleType , TITLE_AREA_HEIGHT , apply_chart_size , default_design , extent_padded , resolved_chart_dimensions , validate_data_array , validate_data_length , validate_dimensions , validate_positive , validate_range , validate_range_log } ;
...
use std::rc::Rc;
use std::sync::Arc;
use super::chart_axis_theme::ChartAxisTheme;
use super::chart_theme::ChartTheme;
use super::misc::format_log_tick;
...
pub struct LineChart {
    ...
    pub(super) y2_label: Option<String>,
    pub(super) y2_range: Option<[f64; 2]>,
    /// Set of hidden series indices (0 = primary series, 1+ = additional series)
    pub(super) hidden_series: HashSet<usize>,
