...
impl ShowcaseApp {
    ...
    pub(super) fn render_sidebar(&mut self, sidebar_width: f32, cx: &mut Context<Self>) -> impl IntoElement {
    ...
    pub(super) fn feature_item(&self, title: &str, desc: &str, theme: &Theme, ds: &DesignSystem) -> Div {
        div()
            .flex()
            .gap(px(ds.spacing.control_gap))
            .child(
