...
# [doc = " Integration tests ported from the TypeScript pretext test suite."] # [doc = ""] # [doc = " Uses a deterministic \"fake canvas\" measure that mimics the original test's"] # [doc = " character-width model:"] # [doc = " - Space: 0.33× font_size (compressible)"] # [doc = " - Tab: 1.32× font_size"] # [doc = " - Punctuation (.,!?:;()[]{}\"'): 0.4× font_size"] # [doc = " - Regular characters: 0.6× font_size"] use gpui_pretext :: { LayoutCursor , LineBreakStrategy , TextMeasure , layout , layout_next_line , layout_optimal , layout_with_lines , layout_with_lines_optimal , layout_with_strategy , prepare , prepare_with_segments , walk_line_ranges , walk_line_ranges_optimal } ;
