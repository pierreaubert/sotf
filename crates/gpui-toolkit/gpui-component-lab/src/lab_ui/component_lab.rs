...
use crate :: { ComponentStory , LivePreviewReload , MotionPreset , ResponsivePreviewMatrix , StoryDocument , StoryProp , StoryPropValue , StoryRegistry , StoryRendererRegistry , ThemePreset , ViewportPreset , builtin_story_registry , builtin_story_renderers , latest_story_or_token_modified , load_story_documents , reload_live_preview_state } ;
use anyhow :: { Context as AnyhowContext , Result } ;
use gpui::prelude::*;
use gpui :: { AnyElement , Context , Entity , IntoElement , Render , SharedString , WeakEntity , Window , div , px , relative } ;
use gpui_audio_kit::{
...
use gpui_px :: { ColorScale , LegendPosition , StrokeDashArray , area , bar , boxplot , contour , donut , heatmap , isoline , line , pie , scatter , surface3d , treemap } ;
use gpui_ui_kit::qr::AnimatedQrCode;
use gpui_ui_kit::showcase::{Showcase, ShowcaseSection};
use gpui_ui_kit::theme::ThemeExt;
use gpui_ui_kit :: { Accordion , AccordionItem , Alert , Avatar , AvatarGroup , AvatarShape , AvatarSize , AvatarStatus , Badge , BadgeDot , BadgeSize , BadgeVariant , BreadcrumbItem , Breadcrumbs , Button , ButtonSet , ButtonSetOption , ButtonSize , ButtonVariant , Card , Checkbox , CheckboxSize , CircularProgress , Code , Color , ColorPickerView , Column , CommandItem , CommandPalette , ConfirmDialog , ContextMenu , DesignSystem , Dialog , DialogSize , Divider , DragItem , DragList , EmptyState , FocusDirection , FocusGroup , HStack , Heading , IconButton , IconButtonSize , ImageView , InlineAlert , Input , InputSize , KeyboardShortcutLabel , KeyboardShortcutSize , Link , LoadingDots , LoadingOverlay , Menu , MenuBar , MenuBarItem , MenuItem , Notification , NumberInput , NumberInputSize , PaneDivider , Popover , Port , PortDirection , Position , Progress , ProgressSize , QrCode , SearchBar , SearchBarSize , Select , SelectOption , SelectSize , SettingsForm , SettingsRow , Sidebar , Slider , Spacer , Spinner , SpinnerSize , SplitDirection , SplitPane , StatusBar , StepIndicator , StepIndicatorSize , StepItem , StepItemStatus , StepOrientation , StepStatus , TabItem , Table , Tabs , Tag , Text , TextSize , TextWeight , Toast , ToastContainer , ToastPosition , Toggle , ToggleSize , ToggleStyle , Toolbar , ToolbarItem , Tooltip , TreeNode , TreeView , VStack , WithTooltip , Wizard , WizardHeader , WizardNavigation , WizardVariant , WorkflowCanvas , WorkflowNode , WorkflowNodeData } ;
use serde_json :: { json } ;
...
impl ComponentLab {
    ...
    pub(super) fn render_story_renderer(&self, story: &ComponentStory, cx: &mut Context<Self>) -> AnyElement {
        let theme = cx.theme();
    ...
    pub(super) fn render_story_metadata(&self, story: &ComponentStory, cx: &mut Context<Self>) -> AnyElement {
        let theme = cx.theme();
        let mut rows = div().flex().flex_col().gap_2();
