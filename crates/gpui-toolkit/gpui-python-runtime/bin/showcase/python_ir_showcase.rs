...
impl PythonIrShowcase {
    ...
    pub(super) fn render_sidebar(&mut self, theme: &Theme, ds: &DesignSystem, cx: &mut Context<Self>) -> Div {
        div()
            .w(px(240.0))
            .h_full()
            .flex()
    ...
    pub(super) fn render_heading(&self, node: &TextNode, theme: &Theme, ds: &DesignSystem) -> AnyElement {
    ...
    pub(super) fn render_text(&self, node: &TextNode, theme: &Theme, ds: &DesignSystem) -> AnyElement {
        div()
            .text_size(px(ds.typography.small_size))
    ...
    pub(super) fn render_code(&self, node: &TextNode, theme: &Theme, ds: &DesignSystem) -> AnyElement {
        div()
            .px(px(ds.spacing.control_padding_x))
            .py(px(ds.spacing.control_padding_y))
    ...
    pub(super) fn render_badge(&self, node: &BadgeNode, theme: &Theme, ds: &DesignSystem) -> AnyElement {
    ...
    pub(super) fn render_progress(&self, node: &ProgressNode, theme: &Theme, ds: &DesignSystem) -> AnyElement {
    ...
    pub(super) fn render_spinner(&self, node: &SpinnerNode, theme: &Theme, ds: &DesignSystem) -> AnyElement {
        div()
            .flex()
            .items_center()
            .gap(px(ds.spacing.control_gap))
    ...
    pub(super) fn render_tabs(&self, node: &TabsNode, theme: &Theme, ds: &DesignSystem) -> AnyElement {
        div()
            .flex()
            .gap(px(ds.spacing.grid_unit))
    ...
    pub(super) fn render_table(&self, node: &TableNode, theme: &Theme, ds: &DesignSystem) -> AnyElement {
        let mut table = div()
            .flex()
            .flex_col()
            .rounded(px(ds.corners.md))
    ...
    pub(super) fn render_chart(&self, node: &ChartNode, theme: &Theme, ds: &DesignSystem) -> AnyElement {
    ...
    pub(super) fn render_lines_spec(&mut self, value: &Value, theme: &Theme, ds: &DesignSystem) -> AnyElement {
    ...
    pub(super) fn render_mesh_summary(&self, value: &Value, theme: &Theme, ds: &DesignSystem) -> AnyElement {
    ...
    pub(super) fn render_scene_summary(&self, value: &Value, theme: &Theme, ds: &DesignSystem) -> AnyElement {
    ...
    pub(super) fn render_error(&self, message: &str, theme: &Theme, ds: &DesignSystem) -> AnyElement {
        div()
            .p(px(ds.spacing.card_padding))
