...
# [cfg (any (target_os = "linux" , target_os = "macos" , target_os = "windows"))] use crate :: { ExternalPluginTrust } ;
...
#[cfg(any(target_os = "linux", target_os = "macos", target_os = "windows"))]
pub(super) fn external_plugin_trust(parameters: &serde_json::Value) -> Result<ExternalPluginTrust, String> {
