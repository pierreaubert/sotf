...
use std :: path :: { Path } ;
use serde_json::json;
use sotf_plugins :: { IsolatedExternalPluginWorkerReport , PluginDescriptor , PluginSandboxLaunchBackend } ;
use super::types::CliLifecycleMode;
use super::worker::worker_reports_json;

pub(super) fn print_discovered_plugins(plugins: &[PluginDescriptor], json_output: bool) -> Result<(), String> {
    if json_output {
