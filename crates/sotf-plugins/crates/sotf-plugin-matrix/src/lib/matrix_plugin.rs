...
impl MatrixPlugin {
    ...
    pub(super) fn create_identity_matrix(input_channels: usize, output_channels: usize) -> Vec<f32> {
...
mod tests {
    ...
    fn test_set_parameter_non_finite_gain_is_ignored() {
        ...
        assert!(
            plugin
                .set_parameter(ParameterId::from("gain_0_0"), ParameterValue::Float(f32::NAN))
                .is_ok()
        );
