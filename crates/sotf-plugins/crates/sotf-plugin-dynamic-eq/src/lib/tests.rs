...
use super::params::{MAX_BANDS, PARAMS as DQ};
...
mod misc;
    ...
    fn test_dynamic_eq_data_update() {
        ...
        let gr: Vec<f32> = (*data.gain_reduction_db).iter().copied().collect();
    ...
    fn test_inactive_band_passthrough() {
        ...
        let max_diff = buf
            ...
            .map(|(a, b)| (a - b).abs())
            .fold(0.0f32, f32::max);
        assert!(max_diff < 1.0e-5, "inactive band should be passthrough, max diff {max_diff}");
    }
