...
# [cfg (any (feature = "external-plugin-clap" , feature = "external-plugin-vst3" , feature = "external-plugin-au"))]
...
pub(super) fn load_clap_backend(descriptor: &PluginDescriptor) -> Result<Box<dyn Any + Send>, String> {
    load_dynamic_library_with_symbols(descriptor, &[b"clap_entry\0"], "CLAP")
}

#[cfg(not(feature = "external-plugin-clap"))]
pub(super) fn load_clap_backend(_descriptor: &PluginDescriptor) -> Result<Box<dyn Any + Send>, String> {
    Err("CLAP backend feature is disabled".to_string())
}

#[cfg(feature = "external-plugin-vst3")]
pub(super) fn load_vst3_backend(descriptor: &PluginDescriptor) -> Result<Box<dyn Any + Send>, String> {
    load_dynamic_library_with_symbols(descriptor, &[b"GetPluginFactory\0"], "VST3")
}

#[cfg(not(feature = "external-plugin-vst3"))]
pub(super) fn load_vst3_backend(_descriptor: &PluginDescriptor) -> Result<Box<dyn Any + Send>, String> {
    Err("VST3 backend feature is disabled".to_string())
}

#[cfg(feature = "external-plugin-au")]
pub(super) fn load_audio_unit_backend(descriptor: &PluginDescriptor) -> Result<Box<dyn Any + Send>, String> {
...
pub(super) fn load_audio_unit_backend(_descriptor: &PluginDescriptor) -> Result<Box<dyn Any + Send>, String> {
