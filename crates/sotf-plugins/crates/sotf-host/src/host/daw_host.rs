...
impl DawHost {
    ...
    pub(super) fn auto_oversample_plugin(&self, plugin: Box<dyn Plugin>) -> Result<Box<dyn Plugin>, String> {
    ...
    pub fn set_plugin_parameter(
        ...
        self.queue_node_parameter(nid, super::super::parameters::ParameterId(id.to_string()), val)
    }
    ...
    pub(super) fn plugin_supports_f64_isolated(plugin: &dyn Plugin, node_id: NodeId, node_name: &str) -> bool {
    ...
    pub(super) fn can_split_parameter_event_block_f64(&self, input: &[f64], output: &[f64]) -> bool {
    ...
    pub(super) fn cycle_util(&self, id: NodeId, v: &mut HashSet<NodeId>, r: &mut HashSet<NodeId>) -> bool {
        if r.contains(&id) {
            return true;
        }
        if v.contains(&id) {
