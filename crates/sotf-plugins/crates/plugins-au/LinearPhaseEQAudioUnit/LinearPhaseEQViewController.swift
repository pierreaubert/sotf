...
public class LinearPhaseEQViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: LinearPhaseEQAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "LinearPhaseEQ", audioUnit: audioUnit)
