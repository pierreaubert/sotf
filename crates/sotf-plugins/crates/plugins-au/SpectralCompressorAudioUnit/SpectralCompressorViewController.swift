...
public class SpectralCompressorViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: SpectralCompressorAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "SpectralCompressor", audioUnit: audioUnit)
