...
public class ConvolutionViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: ConvolutionAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "Convolution", audioUnit: audioUnit)
