...
public class UpmixerViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: UpmixerAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "Upmixer", audioUnit: audioUnit)
