...
public class AECViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: AECAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "AEC", audioUnit: audioUnit)
