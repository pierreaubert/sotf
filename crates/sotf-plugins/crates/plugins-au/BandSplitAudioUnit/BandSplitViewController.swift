...
public class BandSplitViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: BandSplitAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "BandSplit", audioUnit: audioUnit)
