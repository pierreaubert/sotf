...
public class LoudnessCompensationViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: LoudnessCompensationAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "LoudnessCompensation", audioUnit: audioUnit)
