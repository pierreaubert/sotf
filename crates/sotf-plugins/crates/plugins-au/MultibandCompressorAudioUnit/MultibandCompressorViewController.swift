...
public class MultibandCompressorViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: MultibandCompressorAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "MultibandCompressor", audioUnit: audioUnit)
