...
public class MonoToStereoViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: MonoToStereoAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "MonoToStereo", audioUnit: audioUnit)
