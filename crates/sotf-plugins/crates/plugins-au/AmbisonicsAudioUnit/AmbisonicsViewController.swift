...
public class AmbisonicsViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: AmbisonicsAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "AmbisonicsDecoder", audioUnit: audioUnit)
