...
public class BeamformerViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: BeamformerAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "Beamformer", audioUnit: audioUnit)
