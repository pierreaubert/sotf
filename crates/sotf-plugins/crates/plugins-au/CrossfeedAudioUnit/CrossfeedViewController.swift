...
public class CrossfeedViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: CrossfeedAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "Crossfeed", audioUnit: audioUnit)
