...
public class BinauralViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: BinauralAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "Binaural", audioUnit: audioUnit)
