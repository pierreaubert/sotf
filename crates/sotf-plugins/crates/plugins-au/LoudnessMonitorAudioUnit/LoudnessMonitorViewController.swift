...
public class LoudnessMonitorViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: LoudnessMonitorAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "LoudnessMonitor", audioUnit: audioUnit)
