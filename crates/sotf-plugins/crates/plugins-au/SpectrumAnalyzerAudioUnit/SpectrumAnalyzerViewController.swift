...
public class SpectrumAnalyzerViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: SpectrumAnalyzerAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "SpectrumAnalyzer", audioUnit: audioUnit)
