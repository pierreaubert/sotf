...
public class FletcherMunsonViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: FletcherMunsonAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "FletcherMunson", audioUnit: audioUnit)
