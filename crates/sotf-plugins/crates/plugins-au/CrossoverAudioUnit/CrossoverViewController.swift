...
public class CrossoverViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: CrossoverAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "Crossover", audioUnit: audioUnit)
