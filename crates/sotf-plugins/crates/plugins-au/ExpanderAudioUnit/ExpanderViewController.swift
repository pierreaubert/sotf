...
public class ExpanderViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: ExpanderAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "Expander", audioUnit: audioUnit)
