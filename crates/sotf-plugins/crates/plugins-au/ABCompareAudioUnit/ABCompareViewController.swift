...
public class ABCompareViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: ABCompareAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "ABCompare", audioUnit: audioUnit)
