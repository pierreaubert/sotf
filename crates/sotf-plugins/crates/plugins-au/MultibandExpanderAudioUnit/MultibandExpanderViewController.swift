...
public class MultibandExpanderViewController: AUViewController, AUAudioUnitFactory {
    nonisolated(unsafe) private var audioUnit: MultibandExpanderAudioUnit?
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        let gpui = GPUIAUView(pluginType: "MultibandExpander", audioUnit: audioUnit)
