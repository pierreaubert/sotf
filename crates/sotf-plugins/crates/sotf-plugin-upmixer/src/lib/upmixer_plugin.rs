...
impl UpmixerPlugin {
    ...
    pub(super) fn fold_accumulator_frame_to_binaural(&self, accumulator: &[f32], base: usize) -> (f32, f32) {
        let mut left = 0.0;
        let mut right = 0.0;
...
impl Plugin for UpmixerPlugin {
    ...
    fn initialize(&mut self, sample_rate: u32) -> PluginResult<()> {
        ...
        #[cfg(feature = "onnx")]
        {
            self.mfcc_extractor = Some(super::ml_features::MfccExtractor::new(sample_rate, self.fft_size));
        }
