...
#[inline(always)]
pub(super) fn ambient_gain_with_controls(diffuseness: f32, ambient_boost: f32, dialogue_control: f32) -> f32 {
...
#[inline(always)]
pub(super) fn transition_crossfade_weight(bin: usize, transition_start: usize, transition_width: f32) -> f32 {
