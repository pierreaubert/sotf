...
impl ArtifactTracker {
    ...
    pub(super) fn observe_boundary_step(&mut self, value: f32, frame: usize, channel: usize, block: usize) {
    ...
    pub(super) fn observe_hop_step(&mut self, value: f32, frame: usize, channel: usize, block: usize) {
    ...
    pub(super) fn observe_second_diff(&mut self, value: f32, frame: usize, channel: usize, block: usize) {
