...
impl AaePlugin {
    ...
    pub(super) fn apply_auto_gain(&mut self, output: &mut [f32], num_frames: usize) -> PluginResult<()> {
    ...
    pub(super) fn apply_output_safety_limit(&mut self, output: &mut [f32], num_frames: usize, out_ch: usize) {
...
impl Plugin for AaePlugin {
    ...
    fn initialize(&mut self, sample_rate: u32) -> PluginResult<()> {
        ...
        // Rebuild pre-delay
        self.pre_delay = super::delay_line::DelayLine::new((MAX_PRE_DELAY_MS * 0.001 * sr) as usize + 16);
