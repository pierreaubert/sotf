...
// generates a linear- or minimum-phase FIR via frequency sampling, and applies
// it via overlap-add FFT convolution.
//
// Hard rules:
...
use crate::params::{FIR_LENGTH_OPTIONS, PARAMS, PHASE_MODE_OPTIONS};
...
fn default_phase_mode_index() -> usize {
...
impl FirDesignerPlugin {
    ...
    pub fn from_params(
        channels: usize,
        sample_rate: u32,
        params: FirDesignerPluginParams,
    ) -> Result<Self, String> {
    ...
    fn rebuild_cached_parameters(&mut self) {
        let mut params = vec![
            Parameter::new_int(
                ...
                pk(PARAMS, "num_filters").min_f64() as i32,
                pk(PARAMS, "num_filters").max_f64() as i32,
            )
            ...
            Parameter::new_float(
                ...
                "Mix",
                self.mix_value,
                pk(PARAMS, "mix").min_f64() as f32,
                pk(PARAMS, "mix").max_f64() as f32,
            )
