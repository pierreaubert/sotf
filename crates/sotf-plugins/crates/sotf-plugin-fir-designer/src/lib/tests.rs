...
use super::misc::{filter_type_to_index, fir_length_from_index, index_to_filter_type, parse_filter_type};
use super::params;
...
const DEFAULT_SAMPLE_RATE: u32 = 48000;
    ...
    fn test_set_parameter_num_filters_grows_bands() {
        ...
        // Shrink back
        plugin
            .set_parameter(ParameterId::from("num_filters"), ParameterValue::Int(original as i32))
            .unwrap();
    ...
    fn test_get_parameter_unknown_returns_none() {
        ...
        assert!(plugin.get_parameter(&ParameterId::from("unknown")).is_none());
        assert!(plugin.get_parameter(&ParameterId::from("band_99_gain")).is_none());
    }
    ...
    fn test_parameters_reflect_state() {
        ...
        assert!(plugin.parameters().iter().any(|p| p.id == ParameterId::from("band_0_gain")));
    }
