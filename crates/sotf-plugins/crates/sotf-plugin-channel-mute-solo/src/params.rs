...
fn d_dim_gain_db() -> f64 {
    pk(PARAMS, "dim_gain_db").default_f64()
}
fn d_fade_ms() -> f64 {
    pk(PARAMS, "fade_ms").default_f64()
}
...
impl PluginParamDef for Params {
    ...
    fn set_param_value(&mut self, index: usize, value: f64) {
        match index {
            ...
            1 => self.dim_gain_db = value,
            2 => self.fade_ms = value,
            _ => {}
        }
    }
}
...
mod tests {
    ...
    fn deserialize_empty_json_uses_defaults() {
        ...
        assert!(p.enabled);
        assert_eq!(p.dim_gain_db, pk(PARAMS, "dim_gain_db").default_f64());
        assert_eq!(p.fade_ms, pk(PARAMS, "fade_ms").default_f64());
    }
}
