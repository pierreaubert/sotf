...
pub(super) fn create_compressor_plugin_config(args: &CompressorArgs) -> Result<PluginConfig, String> {
    use serde_json::json;
    Ok(PluginConfig {
...
pub(super) fn create_fletcher_munson_plugin_config(args: &FletcherMunsonArgs) -> Result<PluginConfig, String> {
    use serde_json::json;
...
pub(super) fn create_convolution_plugin_config(args: &ConvolutionArgs) -> Result<PluginConfig, String> {
    use serde_json::json;
...
pub(super) fn create_ab_compare_plugin_config(args: &ABCompareArgs) -> Result<PluginConfig, String> {
    use serde_json::json;
    Ok(PluginConfig {
...
pub(super) fn create_band_split_plugin_config(args: &BandSplitArgs) -> Result<PluginConfig, String> {
    use serde_json::json;
    Ok(PluginConfig {
...
pub(super) fn create_band_merge_plugin_config(args: &BandMergeArgs) -> Result<PluginConfig, String> {
    use serde_json::json;
    Ok(PluginConfig {
...
pub(super) fn create_mono_to_stereo_plugin_config(args: &MonoToStereoArgs) -> Result<PluginConfig, String> {
    use serde_json::json;
    Ok(PluginConfig {
