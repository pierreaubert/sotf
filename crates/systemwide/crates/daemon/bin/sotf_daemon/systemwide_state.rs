...
impl SystemwideState {
    ...
    pub(super) fn prepare_with_selected_device(&self, output_device: String) -> Result<PipelinePlan, String> {
    ...
    pub(super) fn set_desired_output_device(&mut self, output_device: Option<String>) -> Result<(), String> {
