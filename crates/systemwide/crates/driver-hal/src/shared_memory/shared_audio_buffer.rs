...
impl SharedAudioBuffer {
    pub(super) fn audio_layout(buffer_frames: u32, channel_count: u32) -> io::Result<(usize, usize, usize)> {
    ...
    pub(super) fn initialize_header(&mut self, sample_rate: u32, buffer_frames: u32, channel_count: u32) {
...
pub(super) fn load_initial_cipher(buffer: &SharedAudioBuffer) -> Option<crate::encryption::AudioCipher> {
