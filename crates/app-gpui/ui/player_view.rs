...
pub struct PlayerView {
    ...
    pub(super) pending_geometry_save: std::sync::Arc<parking_lot::Mutex<Option<PendingGeometrySave>>>,
...
impl PlayerView {
    ...
    pub(super) fn cycle_language(&mut self, _: &CycleLanguage, _: &mut Window, cx: &mut Context<Self>) {
        self.state.update(cx, |state, cx| {
    ...
    pub(super) fn toggle_search(&mut self, _: &ToggleSearch, window: &mut Window, cx: &mut Context<Self>) {
    ...
    pub(super) fn toggle_expand(&mut self, _: &ToggleExpand, _: &mut Window, cx: &mut Context<Self>) {
        self.state.update(cx, |state, _cx| {
    ...
    pub(super) fn fill_queue_magic(&mut self, _: &FillQueueMagic, _: &mut Window, cx: &mut Context<Self>) {
    ...
    pub(super) fn add_directory(&mut self, _: &AddDirectory, _: &mut Window, cx: &mut Context<Self>) {
