...
use super::consts::CHART_TOP_MARGIN;
use super::consts::CHART_WIDTH;
...
use super::consts::calculate_plot_width;
use super::consts::freq_to_x;
use super::consts::level_to_y;
...
impl PlayerView {
    ...
    pub(super) fn load_custom_target_curve(&mut self, cx: &mut Context<Self>) {
    ...
    pub(super) fn save_custom_target_curve(&mut self, cx: &mut Context<Self>) {
        #[cfg(not(any(target_os = "ios", target_os = "tvos")))]
        {
