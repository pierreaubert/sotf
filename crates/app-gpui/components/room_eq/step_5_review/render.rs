...
use gpui::prelude::*;
use gpui::*;
use gpui_ui_kit :: { Card , HStack , Select , SelectSize , StackSpacing , TabItem , TabVariant , Tabs , Text , TextSize , TextWeight , Toggle , VStack } ;
...
impl PlayerView {
    ...
    pub(super) fn render_selected_channel_result(&self, cx: &mut Context<Self>) -> impl IntoElement {
        let d = Ds::from_cx(cx);
