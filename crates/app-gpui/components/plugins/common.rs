...
pub fn param_index_to_engine_param(
    ...
    match settings {
        ...
        PluginSettings::Denoiser {
            ...
            11 => Some(("mcra_delta".to_string(), format!("{}", mcra_delta))),
            12 => Some(("transparency".to_string(), format!("{}", transparency))),
            13 => Some(("dd_enabled".to_string(), dd_enabled.to_string())),
            14 => Some(("dd_alpha".to_string(), format!("{}", dd_alpha))),
            15 => Some((
                "psychoacoustic_masking".to_string(),
                psychoacoustic_masking.to_string(),
            )),
            16 => None, // learn_noise trigger
            17 => Some((
                "use_captured_profile".to_string(),
                use_captured_profile.to_string(),
            )),
            18 => None, // clear_profile trigger
            _ => None,
        },
        PluginSettings::Pnd {
            correction_strength,
        ...
        PluginSettings::XTC {
            ...
            2 => Some(("head_radius_m".to_string(), format!("{}", head_radius_m))),
            3 => Some(("head_offset_x".to_string(), format!("{}", head_offset_x))),
