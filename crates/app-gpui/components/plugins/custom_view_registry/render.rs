...
pub(super) fn render_dynamic_eq(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
...
pub(super) fn render_fir_designer(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
    use super::super::ui_eq;
...
pub(super) fn render_spectrum(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
...
pub(super) fn render_upmixer(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
...
pub(super) fn render_mute_solo(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
    let d = Ds::from_cx(cx);
...
pub(super) fn render_matrix(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
    let d = Ds::from_cx(cx);
...
pub(super) fn render_loudness(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
    let d = Ds::from_cx(cx);
...
pub(super) fn render_mb_compressor(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
    let d = Ds::from_cx(cx);
...
pub(super) fn render_mb_expander(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
    let d = Ds::from_cx(cx);
...
pub(super) fn render_ab_compare(ctx: &CustomViewRenderContext, cx: &mut Context<PlayerView>) -> AnyElement {
