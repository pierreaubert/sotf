...
impl PlayerView {
    ...
    pub(super) fn render_speaker_mode_toggle(
        &self,
        cx: &mut Context<Self>,
        speaker_idx: usize,
        is_multi: bool,
    ...
    pub(super) fn render_multi_channel_list(
        &self,
        cx: &mut Context<Self>,
        speaker_idx: usize,
    ...
    pub(super) fn render_channel_name_input_raw(
        &self,
        cx: &mut Context<Self>,
        channel_idx: usize,
        current_name: &str,
    ...
    pub(super) fn render_channel_group_dropdown(
        &self,
        cx: &mut Context<Self>,
        channel_idx: usize,
        current_group: &str,
