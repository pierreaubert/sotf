...
impl PlayerView {
    ...
    pub(super) fn render_plot_controls(&self, cx: &mut Context<Self>) -> impl IntoElement {
        let state = self.state.read(cx);
        let theme = state.app.ui_state.theme.clone();
        let translations = state.app.ui_state.translations.clone();
    ...
    pub(super) fn get_filtered_results(
        &self,
        cx: &mut Context<Self>,
    ...
    pub(super) fn render_spectrogram_chart(
        &self,
        d: &Ds,
    ...
    pub(super) fn render_spectrogram_canvas(
        &self,
        d: Ds,
        spectrogram: &[Vec<f32>],
        theme: &crate::theme::Theme,
    ...
    pub(super) fn compute_average_spl(frequencies: &[f32], magnitude_db: &[f32]) -> Option<f32> {
        let mut sum = 0.0_f32;
        let mut count = 0;
    ...
    pub(super) fn render_magnitude_chart(
        &self,
        results: &[(String, usize, RecordingResult)],
        smoothing: PlotSmoothing,
        theme: &crate::theme::Theme,
    ...
    /// Render phase chart
    pub(super) fn render_phase_chart(
        &self,
        results: &[(String, usize, RecordingResult)],
        smoothing: PlotSmoothing,
        theme: &crate::theme::Theme,
    ...
    pub(super) fn render_group_delay_chart(
        &self,
        results: &[(String, usize, RecordingResult)],
        smoothing: PlotSmoothing,
        theme: &crate::theme::Theme,
    ...
    pub(super) fn render_distortion_chart(
        &self,
        d: &Ds,
        results: &[(String, usize, RecordingResult)],
        smoothing: PlotSmoothing,
    ...
    /// Render RT60 chart
    pub(super) fn render_rt60_chart(
        &self,
        results: &[(String, usize, RecordingResult)],
        smoothing: PlotSmoothing,
        theme: &crate::theme::Theme,
    ...
    pub(super) fn render_clarity_chart(
        &self,
        results: &[(String, usize, RecordingResult)],
        smoothing: PlotSmoothing,
        theme: &crate::theme::Theme,
    ...
    pub(super) fn find_ir_peak_time(times: &[f32], impulse: &[f32]) -> f32 {
        impulse
            .iter()
            .enumerate()
            .max_by(|(_, a), (_, b)| {
    ...
    pub(super) fn render_impulse_response_chart(
        &self,
        results: &[(String, usize, RecordingResult)],
        theme: &crate::theme::Theme,
    ) -> impl IntoElement {
    ...
    pub(super) fn render_channel_summary(&self, cx: &mut Context<Self>) -> impl IntoElement {
        let state = self.state.read(cx);
        let theme = state.app.ui_state.theme.clone();
        let translations = state.app.ui_state.translations.clone();
        let recording_state = &state.app.measurement_state.recording_state;
