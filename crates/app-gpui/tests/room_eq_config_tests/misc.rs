...
/// no metadata.
pub(super) fn output(channels: std::collections::HashMap<String, ChannelDspChain>) -> DspChainOutput {
    DspChainOutput {
...
pub(super) fn extract_filter_freqs(channel_result_names: &[String], dsp_output: &DspChainOutput) -> Vec<f64> {
