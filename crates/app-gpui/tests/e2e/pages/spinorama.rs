...
impl<'a, 'b> SpinoramaPage<'a, 'b> {
            ...
            .update(self.driver.cx, |view, _window, cx| {
                view.state.update(cx, |state, _cx| {
                    state
                        ...
                        .measurement_state
                        .spinorama_eq_state
                        .selected_speaker = Some(speaker.clone());
                    state
                        .app
                        .measurement_state
                        .spinorama_eq_state
    ...
    pub fn inject_mock_data(&mut self) {
        self.driver.update_app(|app, _| {
            ...
            app.measurement_state.spinorama_eq_state.selected_speaker =
                Some("Genelec 8351B".to_string());
            ...
            app.measurement_state
                .spinorama_eq_state
                .available_measurements = vec!["CEA2034".to_string()];
            ...
            app.measurement_state.spinorama_eq_state.spinorama_curves =
                sotf_audio_player_gpui::app::types::SpinoramaCurves {
            ...
            app.measurement_state.spinorama_eq_state.step =
                sotf_audio_player_gpui::app::types::SpinoramaStep::Configure;
        });
        self.driver.cx.run_until_parked();
    }
}
