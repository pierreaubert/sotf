...
pub struct FederationTranslations {
    ...
    pub login_starting: &'static str,
    pub login_open_page: &'static str,
    pub login_code_label: &'static str,
    pub login_code_expires: &'static str,
    pub copy_code: &'static str,
    pub cancel_login: &'static str,
    pub login_waiting_browser: &'static str,
}
    ...
    pub fn for_language(language: Language) -> Self {
        match language {
            Language::English => Self {
                ...
                login_starting: "Starting login…",
                login_open_page: "Open this page to sign in:",
                login_code_label: "Code:",
                login_code_expires: "The code expires in a few minutes.",
                copy_code: "Copy",
                cancel_login: "Cancel",
                login_waiting_browser: "Waiting for authorization in the browser…",
            },
            Language::French => Self {
                streaming: "Diffusion",
                ...
                login_starting: "Ouverture de la connexion…",
                login_open_page: "Ouvrez cette page pour vous connecter :",
                login_code_label: "Code :",
                login_code_expires: "Le code expire dans quelques minutes.",
                copy_code: "Copier",
                cancel_login: "Annuler",
                login_waiting_browser: "En attente de l’autorisation dans le navigateur…",
            },
            Language::German => Self {
                streaming: "Streaming",
                ...
                login_starting: "Anmeldung wird gestartet…",
                login_open_page: "Öffnen Sie diese Seite zur Anmeldung:",
                login_code_label: "Code:",
                login_code_expires: "Der Code läuft in wenigen Minuten ab.",
                copy_code: "Kopieren",
                cancel_login: "Abbrechen",
                login_waiting_browser: "Warten auf Autorisierung im Browser…",
            },
            Language::Spanish => Self {
                streaming: "Emisiones",
                ...
                not_logged_in: "Sesión no iniciada",
                login_starting: "Iniciando sesión…",
                login_open_page: "Abra esta página para iniciar sesión:",
                login_code_label: "Código:",
                login_code_expires: "El código caduca en unos minutos.",
                copy_code: "Copiar",
                cancel_login: "Cancelar",
                login_waiting_browser: "Esperando autorización en el navegador…",
            },
        }
    }
}
...
pub struct PluginCommonTranslations {
    ...
    pub denoiser_profile: &'static str,
    pub denoiser_learning: &'static str,
    pub denoiser_active: &'static str,
    pub denoiser_captured: &'static str,
    pub denoiser_none: &'static str,
    pub convolution_ir: &'static str,
    pub convolution_preview: &'static str,
    pub xtc_geometry: &'static str,
    pub crossfeed_signal: &'static str,
    pub binaural_hrtf: &'static str,
    ...
    pub fn for_language(language: Language) -> Self {
        match language {
            Language::English => Self {
                ...
                denoiser_profile: "Noise profile",
                denoiser_learning: "Learning",
                denoiser_active: "Active",
                denoiser_captured: "Captured",
                denoiser_none: "None",
                convolution_ir: "Impulse response",
                convolution_preview: "Preview follows the loaded file",
                xtc_geometry: "Speaker / listener geometry",
                crossfeed_signal: "Stereo crossfeed",
                binaural_hrtf: "Binaural HRTF",
            ...
            Language::French => Self {
                ...
                denoiser_profile: "Profil de bruit",
                denoiser_learning: "Apprentissage",
                denoiser_active: "Actif",
                denoiser_captured: "Capturé",
                denoiser_none: "Aucun",
                convolution_ir: "Réponse impulsionnelle",
                convolution_preview: "L'aperçu suit le fichier chargé",
                xtc_geometry: "Géométrie haut-parleurs / auditeur",
                crossfeed_signal: "Crossfeed stéréo",
                binaural_hrtf: "HRTF binaural",
                upmixer_summary: UpmixerSummaryTranslations {
                    output: "Sortie",
                    width: "Largeur",
                    center: "Centre",
            ...
            Language::German => Self {
                ...
                denoiser_profile: "Rauschprofil",
                denoiser_learning: "Lernen",
                denoiser_active: "Aktiv",
                denoiser_captured: "Erfasst",
                denoiser_none: "Keine",
                convolution_ir: "Impulsantwort",
                convolution_preview: "Vorschau folgt der geladenen Datei",
                xtc_geometry: "Lautsprecher-/Hörer-Geometrie",
                crossfeed_signal: "Stereo-Crossfeed",
                binaural_hrtf: "Binaurales HRTF",
                upmixer_summary: UpmixerSummaryTranslations {
                    output: "Ausgang",
                    width: "Breite",
                    center: "Mitte",
            ...
            Language::Spanish => Self {
                ...
                denoiser_profile: "Perfil de ruido",
                denoiser_learning: "Aprendiendo",
                denoiser_active: "Activo",
                denoiser_captured: "Capturado",
                denoiser_none: "Ninguno",
                convolution_ir: "Respuesta al impulso",
                convolution_preview: "La vista previa sigue el archivo cargado",
                xtc_geometry: "Geometría de altavoces / oyente",
                crossfeed_signal: "Crossfeed estéreo",
                binaural_hrtf: "HRTF binaural",
                upmixer_summary: UpmixerSummaryTranslations {
                    output: "Salida",
                    width: "Anchura",
...
const FRENCH_PLUGIN_LABELS: &[(&str, &str)] = &[
    ...
    ("Response", "Réponse"),
    ("Band", "Bande"),
    ("live GR", "GR en direct"),
    (
        "Impulse response selected",
        "Réponse impulsionnelle sélectionnée",
    ),
    (
        "Choose or drop an impulse-response WAV file",
        "Choisissez ou déposez un fichier WAV de réponse impulsionnelle",
    ),
    (
        "Use the file picker below to load an IR",
        "Utilisez le sélecteur ci-dessous pour charger une RI",
    ),
    ("Distance", "Distance"),
    ("Angle", "Angle"),
    ("Head offset", "Décalage de tête"),
    ("Yaw", "Lacet"),
    ("Thresh", "Seuil"),
    ("Ratio", "Rapport"),
    ("Attack", "Attaque"),
...
const GERMAN_PLUGIN_LABELS: &[(&str, &str)] = &[
    ...
    ("Band", "Band"),
    ("live GR", "Live-GR"),
    ("Impulse response selected", "Impulsantwort ausgewählt"),
    (
        "Choose or drop an impulse-response WAV file",
        "Wählen Sie eine WAV-Impulsantwort oder ziehen Sie sie hierher",
    ),
    (
        "Use the file picker below to load an IR",
        "Laden Sie eine Impulsantwort mit dem Dateiauswahldialog unten",
    ),
    ("Distance", "Abstand"),
    ("Angle", "Winkel"),
    ("Head offset", "Kopfoffset"),
    ("Yaw", "Gierwinkel"),
    ("Thresh", "Schwelle"),
    ("Ratio", "Verhältnis"),
    ("Attack", "Attack"),
...
const SPANISH_PLUGIN_LABELS: &[(&str, &str)] = &[
    ...
    ("Response", "Respuesta"),
    ("Band", "Banda"),
    ("live GR", "GR en directo"),
    (
        "Impulse response selected",
        "Respuesta al impulso seleccionada",
    ),
    (
        "Choose or drop an impulse-response WAV file",
        "Elija o suelte un archivo WAV de respuesta al impulso",
    ),
    (
        "Use the file picker below to load an IR",
        "Use el selector de archivos para cargar una RI",
    ),
    ("Distance", "Distancia"),
    ("Angle", "Ángulo"),
    ("Head offset", "Desplazamiento de cabeza"),
    ("Yaw", "Guiñada"),
    ("Thresh", "Umbral"),
    ("Ratio", "Relación"),
    ("Attack", "Ataque"),
