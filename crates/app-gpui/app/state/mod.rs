...
pub use plugin::{
    ...
    ExternalPluginScanCounts, ExternalPluginUiState, ExternalPluginWorkerHealth, PluginGraphState,
    PluginState, PluginViewMode, external_plugin_error_key, external_plugin_worker_health,
};
