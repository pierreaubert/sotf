...
pub(super) fn parse_decorr_terms(data: &[u8], flags: u32, passes: &mut [DecorrPass]) -> Result<usize> {
...
pub(super) fn parse_decorr_weights(data: &[u8], flags: u32, passes: &mut [DecorrPass]) -> Result<()> {
