...
use crate::consts::{DSD64_SAMPLE_RATE, DSD128_SAMPLE_RATE, DSD256_SAMPLE_RATE, HALF, MAX_CHANNELS};
...
use super::misc::reverse7_lsbs;
    ...
    fn new_rejects_zero_and_too_many_channels() {
        ...
        assert!(
            DstDecoder::new(MAX_CHANNELS + 1, DSD64_SAMPLE_RATE as usize).is_err()
        );
    }
