...
fn main() {
    ...
    println!("  Grid size: {}x{}", freq_response.rows(), freq_response.cols());
    println!("  X range (frequency): ({:.1}, {:.1}) Hz",
             freq_response.x_range.0, freq_response.x_range.1);
    println!("  Y range: {:?}", freq_response.y_range);
    println!("  Z range (magnitude): ({:.2}, {:.2}) dB",
    ...
    println!("  Y range (frequency): ({:.1}, {:.1}) Hz",
    ...
    println!("  X range (freq 1): ({:.1}, {:.1}) Hz",
             freq_2d.x_range.0, freq_2d.x_range.1);
    println!("  Y range (freq 2): ({:.1}, {:.1}) Hz",
    ...
    println!("  Grid size: {}x{}", custom_color.rows(), custom_color.cols());
    println!("  Z range (log frequency): ({:.3}, {:.3})",
             custom_color.z_range.0, custom_color.z_range.1);
    println!("  T range (for coloring): ({:.3}, {:.3})",
