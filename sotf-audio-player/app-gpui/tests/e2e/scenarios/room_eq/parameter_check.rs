...
impl TestScenario for RoomEqParameterCheckScenario {
    ...
    fn execute(
        ...
        driver.update_app(|app, _| {
            app.measurement_state.room_eq_state.data_source = RoomEqDataSource::FromFile("/tmp/test.json".into());
        });
        driver.read_app(|app| {
            if let RoomEqDataSource::FromFile(path) = &app.measurement_state.room_eq_state.data_source {
        ...
        driver.update_app(|app, _| {
            app.measurement_state.room_eq_state.optimizer_config.algorithm = RoomEqAlgorithm::NelderMead;
            app.measurement_state.room_eq_state.optimizer_config.num_filters = 8;
            ...
            app.measurement_state.room_eq_state.optimizer_config.min_freq = 40.0;
            app.measurement_state.room_eq_state.optimizer_config.max_freq = 18000.0;
            app.measurement_state.room_eq_state.optimizer_config.max_iter = 5000;
        });
        ...
        driver.update_app(|app, _| {
             ...
             app.measurement_state.room_eq_state.speaker_configs.push(RoomEqSpeakerConfig {
