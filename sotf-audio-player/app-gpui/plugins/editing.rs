            ...
            match &mut plugin.settings {
                PluginSettings::Upmixer {
                    ...
                    match param_idx {
                        ...
                        16 => {
                            *subharmonic_freq_hz = (*subharmonic_freq_hz + delta * 2.0)
                                .clamp(SUBHARMONIC_FREQ_HZ_MIN as f64, SUBHARMONIC_FREQ_HZ_MAX as f64);
                            true
                        }
                        17 => {
                            *subharmonic_attack_ms = (*subharmonic_attack_ms + delta * 2.0)
                                .clamp(SUBHARMONIC_ATTACK_MS_MIN as f64, SUBHARMONIC_ATTACK_MS_MAX as f64);
                            true
                        }
                        18 => {
                            *subharmonic_release_ms = (*subharmonic_release_ms + delta * 10.0)
                                .clamp(SUBHARMONIC_RELEASE_MS_MIN as f64, SUBHARMONIC_RELEASE_MS_MAX as f64);
                            true
                        }
                        19 => {
                            *decorrelation_lfo_rate_hz = (*decorrelation_lfo_rate_hz + delta * 0.02)
                                .clamp(DECORRELATION_LFO_RATE_HZ_MIN as f64, DECORRELATION_LFO_RATE_HZ_MAX as f64);
                            true
                        }
                        20 => {
                            *velvet_noise_duration_ms = (*velvet_noise_duration_ms + delta * 2.0)
                                .clamp(VELVET_NOISE_DURATION_MS_MIN as f64, VELVET_NOISE_DURATION_MS_MAX as f64);
                            true
                        }
                        21 => {
                            *velvet_noise_density = (*velvet_noise_density + delta * 100.0)
                                .clamp(VELVET_NOISE_DENSITY_MIN as f64, VELVET_NOISE_DENSITY_MAX as f64);
                            true
                        }
                        22 => {
                        ...
                        23 => {
                            *height_transient_reduction = (*height_transient_reduction + delta * 0.05)
                                .clamp(HEIGHT_TRANSIENT_REDUCTION_MIN as f64, HEIGHT_TRANSIENT_REDUCTION_MAX as f64);
                            true
                        }
                        24 => {
                            *height_direct_leak = (*height_direct_leak + delta * 0.02)
                                .clamp(HEIGHT_DIRECT_LEAK_MIN as f64, HEIGHT_DIRECT_LEAK_MAX as f64);
                            true
                        }
                        25 => {
                            *surround_direct_bleed = (*surround_direct_bleed + delta * 0.05)
                                .clamp(SURROUND_DIRECT_BLEED_MIN as f64, SURROUND_DIRECT_BLEED_MAX as f64);
                            true
                        }
                        26 => {
                        ...
                        27 => {
                            *rear_late_reflection = (*rear_late_reflection + delta * 0.02)
                                .clamp(REAR_LATE_REFLECTION_MIN as f64, REAR_LATE_REFLECTION_MAX as f64);
                            true
                        }
                        28 => {
                ...
                PluginSettings::Convolution { mix, gain_db, .. } => {
                    ...
                    match param_idx {
                        ...
                        1 => {
                            *gain_db = (*gain_db + delta * 0.5).clamp(GAIN_DB_MIN as f64, GAIN_DB_MAX as f64);
                            true
                        }
                        _ => false,
                    }
            ...
            match &mut plugin.settings {
                PluginSettings::Upmixer {
                    ...
                    match param_idx {
                        ...
                        1 => {
                            *gain_front_direct = value.clamp(GAIN_FRONT_DIRECT_MIN as f64, GAIN_FRONT_DIRECT_MAX as f64);
                            update_needed = true;
                        }
                        2 => {
                            *gain_front_ambient = value.clamp(GAIN_FRONT_AMBIENT_MIN as f64, GAIN_FRONT_AMBIENT_MAX as f64);
                            update_needed = true;
                        }
                        3 => {
                            *gain_rear_ambient = value.clamp(GAIN_REAR_AMBIENT_MIN as f64, GAIN_REAR_AMBIENT_MAX as f64);
                            update_needed = true;
                        }
                        4 => {
                            *height_gain = value.clamp(GAIN_HEIGHT_MIN as f64, GAIN_HEIGHT_MAX as f64);
                            update_needed = true;
                        }
                        5 => {
                        ...
                        6 => {
                            *lfe_cutoff_hz = value.clamp(LFE_CUTOFF_HZ_MIN as f64, LFE_CUTOFF_HZ_MAX as f64);
                            update_needed = true;
                        }
                        7 => {
                        ...
                        8 => {
                            *center_spread = value.clamp(CENTER_SPREAD_MIN as f64, CENTER_SPREAD_MAX as f64);
                            update_needed = true;
                        }
                        9 => {
                            *bandpass_hz = value.clamp(BANDPASS_HZ_MIN as f64, BANDPASS_HZ_MAX as f64);
                            update_needed = true;
                        }
                        10 => {
                        ...
                        11 => {
                            *subharmonic_gain = value.clamp(SUBHARMONIC_GAIN_MIN as f64, SUBHARMONIC_GAIN_MAX as f64);
                            update_needed = true;
                        }
                        12 => {
                        ...
                        14 => {
                            *safety_cap_db = value.clamp(SAFETY_CAP_DB_MIN as f64, SAFETY_CAP_DB_MAX as f64);
                            update_needed = true;
                        }
                        15 => {
                        ...
                        16 => {
                            *subharmonic_freq_hz = value.clamp(SUBHARMONIC_FREQ_HZ_MIN as f64, SUBHARMONIC_FREQ_HZ_MAX as f64);
                            update_needed = true;
                        }
                        17 => {
                            *subharmonic_attack_ms = value.clamp(SUBHARMONIC_ATTACK_MS_MIN as f64, SUBHARMONIC_ATTACK_MS_MAX as f64);
                            update_needed = true;
                        }
                        18 => {
                            *subharmonic_release_ms = value.clamp(SUBHARMONIC_RELEASE_MS_MIN as f64, SUBHARMONIC_RELEASE_MS_MAX as f64);
                            update_needed = true;
                        }
                        19 => {
                            *decorrelation_lfo_rate_hz = value.clamp(DECORRELATION_LFO_RATE_HZ_MIN as f64, DECORRELATION_LFO_RATE_HZ_MAX as f64);
                            update_needed = true;
                        }
                        20 => {
                            *velvet_noise_duration_ms = value.clamp(VELVET_NOISE_DURATION_MS_MIN as f64, VELVET_NOISE_DURATION_MS_MAX as f64);
                            update_needed = true;
                        }
                        21 => {
                            *velvet_noise_density = value.clamp(VELVET_NOISE_DENSITY_MIN as f64, VELVET_NOISE_DENSITY_MAX as f64);
                            update_needed = true;
                        }
                        22 => {
                            *height_hf_cap_hz = value.clamp(HEIGHT_HF_CAP_HZ_MIN as f64, HEIGHT_HF_CAP_HZ_MAX as f64);
                            update_needed = true;
                        }
                        23 => {
                            *height_transient_reduction = value.clamp(HEIGHT_TRANSIENT_REDUCTION_MIN as f64, HEIGHT_TRANSIENT_REDUCTION_MAX as f64);
                            update_needed = true;
                        }
                        24 => {
                            *height_direct_leak = value.clamp(HEIGHT_DIRECT_LEAK_MIN as f64, HEIGHT_DIRECT_LEAK_MAX as f64);
                            update_needed = true;
                        }
                        25 => {
                            *surround_direct_bleed = value.clamp(SURROUND_DIRECT_BLEED_MIN as f64, SURROUND_DIRECT_BLEED_MAX as f64);
                            update_needed = true;
                        }
                        26 => {
                            *rear_ambient_boost = value.clamp(REAR_AMBIENT_BOOST_MIN as f64, REAR_AMBIENT_BOOST_MAX as f64);
                            update_needed = true;
                        }
                        27 => {
                            *rear_late_reflection = value.clamp(REAR_LATE_REFLECTION_MIN as f64, REAR_LATE_REFLECTION_MAX as f64);
                            update_needed = true;
                        }
                        28 => {
                            *ambient_boost = value.clamp(AMBIENT_BOOST_MIN as f64, AMBIENT_BOOST_MAX as f64);
                            update_needed = true;
                        }
                        29 => {
                            *dialogue_weight = value.clamp(DIALOGUE_WEIGHT_MIN as f64, DIALOGUE_WEIGHT_MAX as f64);
                            update_needed = true;
                        }
                        30 => {
                            *voice_freq_min_hz = value.clamp(VOICE_FREQ_MIN_HZ_MIN as f64, VOICE_FREQ_MIN_HZ_MAX as f64);
                            update_needed = true;
                        }
                        31 => {
                            *voice_freq_max_hz = value.clamp(VOICE_FREQ_MAX_HZ_MIN as f64, VOICE_FREQ_MAX_HZ_MAX as f64);
                            update_needed = true;
                        }
                        _ => {}
                    }
        ...
        let default_value = match &default_settings {
            PluginSettings::Upmixer {
                ...
                match param_idx {
                    ...
                    8 => *center_spread,
                    9 => *bandpass_hz,
                    10 => if *enable_subharmonic_synth { 1.0 } else { 0.0 },
                    11 => *subharmonic_gain,
                    12 => if *enable_hr_direct { 1.0 } else { 0.0 },
                    13 => *hr_sharpen,
                    14 => *safety_cap_db,
