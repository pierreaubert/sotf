//! Spinorama room correction calculations
//!
...
/// A measurement curve with frequency, magnitude, and optional phase data
#[derive(Debug, Clone)]
...
/// A room measurement at a specific position
#[derive(Debug, Clone)]
...
/// Input parameters for room correction calculation
#[derive(Debug, Clone)]
