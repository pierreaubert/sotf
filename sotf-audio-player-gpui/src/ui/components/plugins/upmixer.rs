                    ...
                    div()
                        ...
                        .child(
                            div()
                                ...
                                .gap_3()
                                .justify_center()
                                .child(render_level_meter("FL", fl_level, theme.success, theme))
                                .child(render_level_meter("C", c_level, theme.info, theme))
                                .child(render_level_meter("FR", fr_level, theme.success, theme))
                                .child(render_level_meter("LFE", lfe_level, theme.error, theme))
                                .child(render_level_meter("RL", rl_level, theme.warning, theme))
                                .child(render_level_meter("RR", rr_level, theme.warning, theme)),
                        ),
                ),
        )
