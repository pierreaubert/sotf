...
fn default_documented_keybindings() -> Vec<DocumentedKeybinding> {
    vec![
        // Playback
        DocumentedKeybinding { key: "Space", description: "Play/Pause", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "n / >", description: "Next track", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "b / <", description: "Previous track", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "+ / =", description: "Volume up", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "- / _", description: "Volume down", category: KeybindingCategory::Playback },

        // Navigation
        DocumentedKeybinding { key: "j / ↓", description: "Select next", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "k / ↑", description: "Select previous", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "h / l / ← →", description: "Expand/collapse", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "PgUp/PgDn", description: "Page up/down", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "Ctrl+←/→", description: "Previous/next page", category: KeybindingCategory::Navigation },

        // Screen switching
        DocumentedKeybinding { key: "Shift+L", description: "Library", category: KeybindingCategory::ScreenSwitch },
        DocumentedKeybinding { key: "Shift+Q", description: "Queue", category: KeybindingCategory::ScreenSwitch },
        DocumentedKeybinding { key: "Shift+P", description: "Plugins", category: KeybindingCategory::ScreenSwitch },
        DocumentedKeybinding { key: "Shift+O", description: "Devices", category: KeybindingCategory::ScreenSwitch },
        DocumentedKeybinding { key: "Shift+D", description: "Directory Manager", category: KeybindingCategory::ScreenSwitch },
        DocumentedKeybinding { key: "S", description: "Settings", category: KeybindingCategory::ScreenSwitch },

        // Library
        DocumentedKeybinding { key: "/", description: "Search", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "t", description: "Toggle tree/list view", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "s", description: "Cycle sort order", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "c", description: "Cycle channel filter", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "1-4", description: "Set sort (Artist/Album/Title/Year)", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "5-9", description: "Set filter (All/Mono/Stereo/Multi/Mixed)", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "Enter / a", description: "Add to queue", category: KeybindingCategory::Library },

        // Queue
        DocumentedKeybinding { key: "d / Del", description: "Remove item", category: KeybindingCategory::Queue },

        // Plugins
        DocumentedKeybinding { key: "u", description: "Move plugin up", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "Shift+N", description: "Move plugin down", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "e", description: "Edit plugin", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "! @ # $ % ^ &", description: "Quick add plugins", category: KeybindingCategory::Plugins },

        // Level meters
        DocumentedKeybinding { key: "Tab / Shift+Tab", description: "Next/prev meter group", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "m", description: "Toggle mute", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "Shift+M", description: "Toggle solo", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "Ctrl+M", description: "Toggle dim", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "x", description: "Clear mutes/solos", category: KeybindingCategory::LevelMeters },

        // System
        DocumentedKeybinding { key: "Shift+T", description: "Cycle theme", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Alt+L", description: "Cycle language", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "?", description: "Show help", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Esc", description: "Cancel/close", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Cmd+,", description: "Settings", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Cmd+Q", description: "Quit", category: KeybindingCategory::System },
    ]
}
...
fn vim_documented_keybindings() -> Vec<DocumentedKeybinding> {
    vec![
        // Playback
        DocumentedKeybinding { key: "Space", description: "Play/Pause", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Ctrl+N / ]", description: "Next track", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Ctrl+P / [", description: "Previous track", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "+ / =", description: "Volume up", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "- / _", description: "Volume down", category: KeybindingCategory::Playback },
        ...
        DocumentedKeybinding { key: "k / ↑", description: "Select previous", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "h / l", description: "Expand/collapse", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "Ctrl+U / Ctrl+D", description: "Page up/down", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "gg / G", description: "First/last page", category: KeybindingCategory::Navigation },
        ...
        // Library
        DocumentedKeybinding { key: "/", description: "Search", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "gv", description: "Toggle tree/list view", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "os", description: "Cycle sort order", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "oc", description: "Cycle channel filter", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "o / Enter", description: "Add to queue", category: KeybindingCategory::Library },

        // Queue
        DocumentedKeybinding { key: "dd / x", description: "Remove item", category: KeybindingCategory::Queue },

        // Plugins
        DocumentedKeybinding { key: "K", description: "Move plugin up", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "J", description: "Move plugin down", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "i", description: "Edit plugin", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "! @ # $ % ^ &", description: "Quick add plugins", category: KeybindingCategory::Plugins },

        // Level meters
        DocumentedKeybinding { key: "Tab / Shift+Tab", description: "Next/prev meter group", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "m", description: "Toggle mute", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "M", description: "Toggle solo", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "Ctrl+M", description: "Toggle dim", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "gx", description: "Clear mutes/solos", category: KeybindingCategory::LevelMeters },

        // System
        DocumentedKeybinding { key: "gt", description: "Cycle theme", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "gl", description: "Cycle language", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "? / F1", description: "Show help", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Esc", description: "Cancel/close", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Cmd+Q", description: "Quit", category: KeybindingCategory::System },
    ]
}
...
fn emacs_documented_keybindings() -> Vec<DocumentedKeybinding> {
    vec![
        // Playback
        DocumentedKeybinding { key: "Space", description: "Play/Pause", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Alt+N / >", description: "Next track", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Alt+P / <", description: "Previous track", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Ctrl+X + / +", description: "Volume up", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Ctrl+X - / -", description: "Volume down", category: KeybindingCategory::Playback },

        // Navigation
        DocumentedKeybinding { key: "Ctrl+N / ↓", description: "Select next", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "Ctrl+P / ↑", description: "Select previous", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "Ctrl+F / Ctrl+B", description: "Expand/collapse", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "Alt+V / Ctrl+V", description: "Page up/down", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "Alt+< / Alt+>", description: "First/last page", category: KeybindingCategory::Navigation },
        ...
        // Library
        DocumentedKeybinding { key: "Ctrl+S / /", description: "Search", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "Ctrl+X V", description: "Toggle tree/list view", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "Alt+S", description: "Cycle sort order", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "Alt+C", description: "Cycle channel filter", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "Ctrl+M / Ctrl+J", description: "Add to queue", category: KeybindingCategory::Library },

        // Queue
        DocumentedKeybinding { key: "Ctrl+D / Ctrl+K", description: "Remove item", category: KeybindingCategory::Queue },

        // Plugins
        DocumentedKeybinding { key: "Alt+↑", description: "Move plugin up", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "Alt+↓", description: "Move plugin down", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "Ctrl+X E", description: "Edit plugin", category: KeybindingCategory::Plugins },

        // Level meters
        DocumentedKeybinding { key: "Tab / Shift+Tab", description: "Next/prev meter group", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "Alt+M", description: "Toggle mute", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "Alt+Shift+M", description: "Toggle solo", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "Ctrl+Alt+M", description: "Toggle dim", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "Ctrl+G", description: "Clear mutes/solos", category: KeybindingCategory::LevelMeters },

        // System
        DocumentedKeybinding { key: "Alt+X T", description: "Cycle theme", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Alt+X L", description: "Cycle language", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Ctrl+H / F1", description: "Show help", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Esc", description: "Cancel/close", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Cmd+Q", description: "Quit", category: KeybindingCategory::System },
    ]
}
...
fn vscode_documented_keybindings() -> Vec<DocumentedKeybinding> {
    vec![
        // Playback
        DocumentedKeybinding { key: "Space", description: "Play/Pause", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Ctrl+Shift+N / Alt+→", description: "Next track", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Ctrl+Shift+P / Alt+←", description: "Previous track", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Ctrl+↑ / +", description: "Volume up", category: KeybindingCategory::Playback },
        DocumentedKeybinding { key: "Ctrl+↓ / -", description: "Volume down", category: KeybindingCategory::Playback },

        // Navigation
        DocumentedKeybinding { key: "↓", description: "Select next", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "↑", description: "Select previous", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "← / →", description: "Expand/collapse", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "PgUp / PgDn", description: "Page up/down", category: KeybindingCategory::Navigation },
        DocumentedKeybinding { key: "Home / End", description: "First/last page", category: KeybindingCategory::Navigation },
        ...
        // Library
        DocumentedKeybinding { key: "Ctrl+F / Cmd+F", description: "Search", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "Ctrl+Shift+E", description: "Toggle tree/list view", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "Ctrl+Shift+S", description: "Cycle sort order", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "Ctrl+Shift+C", description: "Cycle channel filter", category: KeybindingCategory::Library },
        DocumentedKeybinding { key: "Enter / Ctrl+Enter", description: "Add to queue", category: KeybindingCategory::Library },

        // Queue
        DocumentedKeybinding { key: "Del / Backspace", description: "Remove item", category: KeybindingCategory::Queue },

        // Plugins
        DocumentedKeybinding { key: "Alt+↑", description: "Move plugin up", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "Alt+↓", description: "Move plugin down", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "F2 / Ctrl+.", description: "Edit plugin", category: KeybindingCategory::Plugins },
        DocumentedKeybinding { key: "! @ # $ % ^ &", description: "Quick add plugins", category: KeybindingCategory::Plugins },
        ...
        DocumentedKeybinding { key: "Shift+M", description: "Toggle solo", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "Ctrl+M", description: "Toggle dim", category: KeybindingCategory::LevelMeters },
        DocumentedKeybinding { key: "Ctrl+Shift+M", description: "Clear mutes/solos", category: KeybindingCategory::LevelMeters },

        // System
        DocumentedKeybinding { key: "Ctrl+K Ctrl+T", description: "Cycle theme", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Ctrl+Shift+L", description: "Cycle language", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "F1", description: "Show help", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Esc", description: "Cancel/close", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Cmd+,", description: "Settings", category: KeybindingCategory::System },
        DocumentedKeybinding { key: "Cmd+Q", description: "Quit", category: KeybindingCategory::System },
