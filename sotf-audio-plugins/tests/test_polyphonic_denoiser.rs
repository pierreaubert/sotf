#[cfg(test)]
mod tests {
    use sotf_plugins::{InPlacePlugin, ProcessContext, DenoiserPlugin, DenoiserPluginParams, ParameterId, ParameterValue};
    ...
    fn test_polyphonic_mode_activation() {
        ...
        let param_val = denoiser.get_parameter(&ParameterId::from("polyphonic_detection"));
